...
```bash
  git clone https://github.com/delia1205/-WADe-Project.git
```

Go to all these project directories to install packages
...
Start the server on all project paths mentioned above
